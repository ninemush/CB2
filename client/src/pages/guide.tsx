...
const sections: GuideSection[] = [
  {
    ...
    content: () => (
      <>
        ...
        <p className="text-muted-foreground leading-relaxed mb-4">
          To get started, log in with the credentials provided by your administrator. Once authenticated, you will land on the Pipeline board where you can see all submitted ideas across 10 stages: Idea, Feasibility Assessment, Validated Backlog, Design, Build, Test, Governance / Security Scan, CoE Approval, Deploy, and Maintenance. Each stage represents a milestone in the automation lifecycle, and ideas advance through these stages automatically as criteria are met or via CoE/Admin approval.
        </p>
  ...
  },
  {
    ...
    content: () => (
      <>
        ...
        <p className="text-muted-foreground leading-relaxed mb-4">
          After you submit the idea, it enters the Idea stage. At this point, it appears on your Ideas dashboard and is visible to CoE reviewers. You can open the idea at any time to continue working on it. When you are ready to begin the AI-assisted discovery process, open the idea&rsquo;s workspace. The system will automatically transition the idea into the Feasibility Assessment stage once you have 3 or more process steps and 4 or more messages in the conversation with the AI assistant.
        </p>
        <p className="text-muted-foreground leading-relaxed">
