...
## Recent Changes
- 2026-02-23: Parallel SDD generation: prose sections (1-7) and orchestrator artifacts (section 8) generated simultaneously via parallel AI calls, reducing generation time by ~40%; dedicated artifact prompt ensures reliable ```orchestrator_artifacts block output; reusable parseArtifactBlock() parser
