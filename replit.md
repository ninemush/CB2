...
- **Canonical 5-Stage Pipeline**: The UiPath generation pipeline follows a canonical single-pass model: Spec Generation → XAML Emission → Compliance Normalization → Validation → Packaging + DHG. Pipeline stage tracking uses these canonical names.
