  ...
  activities: [
    ...
    },
    {
      ...
      properties: [
        ...
        childProp("Messages", { dir: "Out", type: "System.Collections.Generic.List`1[System.Net.Mail.MailMessage]", wrapper: "OutArgument", typeArgs: "scg:List(s:Net.Mail.MailMessage)" }),
        COMMON_CONTINUE_ON_ERROR,
      ],
    },
    {
